...
function geometry(m, z){
	...
	return {
		...
		Df, //Диаметр впадин
		Rf, //Df/2
		Rb, //Базовая окружность эвольвенты
		sa, //Угловое уширение зуба (угол между точкой зацепления и началом эвольвенты)
		zwa, //угловая ширина основания зубца.
		fwa, //угловая ширина впадины
		fwl //линейная ширина впадины
	};
}
